...
export function WorkspaceBar() {
  ...
  return (
    <div data-module-navigation="ams" className="sticky top-16 z-20 -mx-4 mb-4 border-b border-border/60 bg-background/85 px-4 py-2 backdrop-blur-md lg:-mx-6 lg:px-6">
